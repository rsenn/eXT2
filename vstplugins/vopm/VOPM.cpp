...
VstIntPtr VOPM::vendorSpecific (long lArg1, long lArg2, void* ptrArg, float floatArg)
{
//MouseWhell Enable 
...
//-----------------------------------------------------------------------------------------
void VOPM::setProgram (long program)
{
#ifdef DEBUG
...
//-----------------------------------------------------------------------------------------
void VOPM::getParameterLabel (long index, char *label)
{
#if DEBUG
...
//-----------------------------------------------------------------------------------------
void VOPM::getParameterDisplay (long index, char *text)
{
#if DEBUG
...
//-----------------------------------------------------------------------------------------
void VOPM::getParameterName (long index, char *label)
{
...
//-----------------------------------------------------------------------------------------
void VOPM::setParameter (long index, float value)
{
#if DEBUG
...
//-----------------------------------------------------------------------------------------
float VOPM::getParameter (long index)
{
#if DEBUG
	...
	switch (index){
		...
		case kM1KS:value=pVo->Op[0].KS/7.0;break;
		case kM2KS:value=pVo->Op[1].KS/7.0;break;
		case kC1KS:value=pVo->Op[2].KS/7.0;break;
		case kC2KS:value=pVo->Op[3].KS/7.0;break;
...
//-----------------------------------------------------------------------------------------
bool VOPM::getOutputProperties (long index, VstPinProperties* properties)
{
#if DEBUG
...
long VOPM::getChunk(void** data, bool isPreset) {
	unsigned char *pData;
...
long VOPM::setChunk(void* data, long byteSize, bool isPreset) {
	unsigned char *pData;
...
//----------------------------------------------------------------------------
long VOPM::dispatcher (long opCode, long index, long value, void *ptr, float opt)
{
    int result = 0;
