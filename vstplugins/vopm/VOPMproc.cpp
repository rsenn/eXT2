...
//-----------------------------------------------------------------------------------------
void VOPM::process (float **inputs, float **outputs, long sampleFrames)
{
	long fs;
	fs=SampleRate/100;
	rate+=sampleFrames;
...
//-----------------------------------------------------------------------------------------
void VOPM::processReplacing (float **inputs, float **outputs, long sampleFrames)
{
	long fs;
	fs=SampleRate/100;
	rate+=sampleFrames;
...
//-----------------------------------------------------------------------------------------
long VOPM::processEvents (VstEvents* ev)
{
