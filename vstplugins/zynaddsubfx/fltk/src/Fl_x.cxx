...
void fl_open_display(Display* d) {
  ...
  std::cout << "fl_open_display > Fl::add_fd" << std::endl;
  ...
  std::cout << "fl_open_display > fl_message_window" << std::endl;
...
// construct an XVisualInfo that matches the default Visual:
  ...
  std::cout << "fl_open_display > XVisualInfo" << std::endl;

#if !USE_COLORMAP
  Fl::visual(FL_RGB);
 #endif

  std::cout << "fl_open_display > Fl::visual" << std::endl;
}
...
#  endif
  ...
  case ReparentNotify: {
    ...
    std::cout << "fltk received: ReparentNotify" << std::endl;
