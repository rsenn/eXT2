...
void CHorizontalSliderChunky::draw (CDrawContext *pContext)
{
    ...
    pContext->offset (backOffset.x, backOffset.y);
	...
	if (pBackground)
	{
		if (bTransparencyEnabled)
			pBackground->drawTransparent(/*pOScreen*/pContext, rect, offset);
		else
			pBackground->draw(/*pOScreen*/pContext, rect, offset);
	}
	...
	if (pHandle)
	{
		if (bDrawTransparentEnabled)
			pHandle->drawTransparent(/*pOScreen*/pContext, rectNew);
		else 
			pHandle->draw(/*pOScreen*/pContext, rectNew);
	}
...
//------------------------------------------------------------------------
void CNumberBox::mouse(CDrawContext *pContext, CPoint &where, long button)
{
	if (!bMouseEnabled)
		return;
...
//------------------------------------------------------------------------
void CMultiToggle::mouse(CDrawContext *pContext, CPoint &where, long button)
{
	if (!bMouseEnabled)
		return;
...
//------------------------------------------------------------------------
void CWebLink::mouse(CDrawContext *pContext, CPoint &where, long button)
{
	mouseDown = true;
...
//------------------------------------------------------------------------
void CFineTuneButton::mouse(CDrawContext *pContext, CPoint &where, long button)
{
	mouseDown = true;
