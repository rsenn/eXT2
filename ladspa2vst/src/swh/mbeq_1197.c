...
static LADSPA_Handle instantiateMbeq(
 ...
 unsigned long s_rate) {
	...
	in_fifo = (LADSPA_Data*) calloc(FFT_LENGTH, sizeof(LADSPA_Data));
	out_fifo = (LADSPA_Data*) calloc(FFT_LENGTH, sizeof(LADSPA_Data));
	out_accum = (LADSPA_Data*) calloc(FFT_LENGTH * 2, sizeof(LADSPA_Data));
	real = (fftw_real*) calloc(FFT_LENGTH, sizeof(fftw_real));
	comp = (fftw_real*) calloc(FFT_LENGTH, sizeof(fftw_real));
