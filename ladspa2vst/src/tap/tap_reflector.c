...
instantiate_Reflector(const LADSPA_Descriptor * Descriptor,
	...
	if ((ptr = malloc(sizeof(Reflector))) != NULL) {
		...
		if ((((Reflector *)ptr)->ring0 = (LADSPA_Data*)
