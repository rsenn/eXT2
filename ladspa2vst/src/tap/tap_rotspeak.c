...
instantiate_RotSpkr(const LADSPA_Descriptor * Descriptor,
	...
	if ((ptr = malloc(sizeof(RotSpkr))) != NULL) {
		...
		((RotSpkr *)ptr)->run_adding_gain = 1.0;
                ...
                if ((((RotSpkr *)ptr)->ringbuffer_h_L = (LADSPA_Data*)
                     calloc(2 * PM_DEPTH, sizeof(LADSPA_Data))) == NULL)
                        return NULL;
                if ((((RotSpkr *)ptr)->ringbuffer_h_R = (LADSPA_Data*)
                     calloc(2 * PM_DEPTH, sizeof(LADSPA_Data))) == NULL)
                        return NULL;
                ((RotSpkr *)ptr)->buflen_h_L = (unsigned int) ceil(0.3f * sample_rate / M_PI);
                ((RotSpkr *)ptr)->buflen_h_R = (unsigned int) ceil(0.3f * sample_rate / M_PI);
                ((RotSpkr *)ptr)->pos_h_L = 0;
                ((RotSpkr *)ptr)->pos_h_R = 0;

                if ((((RotSpkr *)ptr)->ringbuffer_b_L = (LADSPA_Data*)
                     calloc(2 * PM_DEPTH, sizeof(LADSPA_Data))) == NULL)
                        return NULL;
                if ((((RotSpkr *)ptr)->ringbuffer_b_R = (LADSPA_Data*)
                     calloc(2 * PM_DEPTH, sizeof(LADSPA_Data))) == NULL)
                        return NULL;
                ((RotSpkr *)ptr)->buflen_b_L = (unsigned int) ceil(0.3f * sample_rate / M_PI);
                ((RotSpkr *)ptr)->buflen_b_R = (unsigned int) ceil(0.3f * sample_rate / M_PI);
                ((RotSpkr *)ptr)->pos_b_L = 0;
                ((RotSpkr *)ptr)->pos_b_R = 0;

		if ((((RotSpkr *)ptr)->eq_filter_L = (biquad *)calloc(1, sizeof(biquad))) == NULL)
			return NULL;
		if ((((RotSpkr *)ptr)->lp_filter_L = (biquad *)calloc(1, sizeof(biquad))) == NULL)
			return NULL;
		if ((((RotSpkr *)ptr)->hp_filter_L = (biquad *)calloc(1, sizeof(biquad))) == NULL)
			return NULL;
		
		if ((((RotSpkr *)ptr)->eq_filter_R = (biquad *)calloc(1, sizeof(biquad))) == NULL)
			return NULL;
		if ((((RotSpkr *)ptr)->lp_filter_R = (biquad *)calloc(1, sizeof(biquad))) == NULL)
			return NULL;
		if ((((RotSpkr *)ptr)->hp_filter_R = (biquad *)calloc(1, sizeof(biquad))) == NULL)
			return NULL;
